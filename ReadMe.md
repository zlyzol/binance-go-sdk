...
Add "github.com/zlyzol/binance-go-sdk" dependency into your go.mod file. Example:
```go
require (
	github.com/zlyzol/binance-go-sdk latest
)
...
```GO
import sdk "github.com/zlyzol/binance-go-sdk/client"
...
For more API usage documentation, please check the [wiki](https://github.com/zlyzol/binance-go-sdk/wiki)..
